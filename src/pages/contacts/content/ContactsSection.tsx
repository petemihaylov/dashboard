...
const ContactsSection = () => {
  ...
  return (
    <section id="contact" className="isolate bg-white px-6 pt-12 pb-24 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2 flex gap-x-2 items-center">
            <div className="flex h-6 items-center">
              ...
              >
                <span className="sr-only">{t("contact.agreeToPolicies")}</span>
            ...
            <label className="text-sm text-gray-600" htmlFor="agreeToPolicies">
              <Trans
